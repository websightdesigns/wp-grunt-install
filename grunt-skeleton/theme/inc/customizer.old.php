<?php
/**
 * SKEL_THEME_PREFIX Theme Customizer
 *
...
function SKEL_THEME_PREFIX_customize_preview_js() {
	wp_enqueue_script( 'SKEL_THEME_PREFIX_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
