...
function wpcustomize_settings_page() {
    ...
    if( isset($_POST[ $hidden_field_name ]) && $_POST[ $hidden_field_name ] == 'Y' ) {
        ...
        update_option('wpcustomize_admin_page_url', htmlentities(stripslashes($_POST['wpcustomize_admin_page_url'])));
    ...
    <form name="wpcustomize_customize" method="post" action="">
        ...
        <table class="form-table">
            <tr valign="top">
                <th scope="row"><?php _e("Login Page URL:", 'wp-customize-menu'); ?> </th>
                <td>
                <input type="text" size="42" name="wpcustomize_admin_page_url" value="<?php
                    echo (isset( $_POST['wpcustomize_admin_page_url'] ) && $_POST['wpcustomize_admin_page_url'] ? $_POST['wpcustomize_admin_page_url'] : html_entity_decode(get_option('wpcustomize_admin_page_url', htmlentities(get_option('wpcustomize_admin_page_url')))) );
                ?>">
                 <br />If nothing is entered here, we'll just use <code>/login/</code>
                </td>
            </tr>
            <tr valign="top">
