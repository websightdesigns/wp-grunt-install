...
Tags: automate, customize, admin, login logo, admin footer, custom login, login page, custom page, footer
...
This plugin allows you to activate the plugin for new sites to automatically configure the wordpress settings.
...
1. Upload the `wp-configure` folder to the `/wp-content/plugins/` directory
