      ...
      <div role="tabpanel">
        ...
        <div class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane" id="download">
            ...
            <p class="text-muted"><a href="https://github.com/websightdesigns/my_theme" target="_blank">https://github.com/websightdesigns/SKEL_THEME_PREFIX</a></p>
            <h3>Clone the Repository</h3>
            <div id="copy-wrapper">
              <span class="code text-muted copytext">git clone https://github.com/websightdesigns/my_theme.git</span>
            </div>
            <h3>Contributing</h3>
