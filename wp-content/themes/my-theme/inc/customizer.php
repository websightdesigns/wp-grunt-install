...
function my_theme_customize_preview_js() {
	wp_enqueue_script( 'my_theme_customizer', get_template_directory_uri() . '/js/theme/customizer.js', array( 'customize-preview' ), '20130508', true );
}

/**
 * Custom theme logo
 */
add_action( 'customize_register', 'my_theme_theme_customizer' );
function my_theme_theme_customizer( $wp_customize ) {
