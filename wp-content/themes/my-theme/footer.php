...
?>
	...
	<div id="footer">
		<div class="container">
			<p class="text-muted">&copy; Copyright <?php echo date('Y'); ?>. Some Rights Reserved. <?php printf( __( 'Website by %1$s.', 'my_theme' ), '<a href="http://domain.com" rel="author" target="_blank">John Doe</a>' ); ?></p>
		</div>
	</div>
